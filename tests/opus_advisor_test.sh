...
printf '6. permission denial propagation\n'
set +e
...
printf '8. nonnumeric progress is inert\n'
...
printf '9. empty result rejection\n'
set +e
...
printf '10. numeric progress guard\n'
