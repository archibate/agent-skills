...
2. Use the `$scrapling` skill on the abstract page. `scrapling extract stealthy-fetch --solve-cloudflare` returns the full abstract, authors, citation block, and resolved PDF download URL as markdown.
